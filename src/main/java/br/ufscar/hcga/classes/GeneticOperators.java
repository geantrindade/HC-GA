...
/* ===========================================================
     ...
     * between the parents
     * =========================================================== */
public static ArrayList<Individual> uniformCrossoverDistance() {
    ArrayList<Individual> parents = new ArrayList<Individual>();
    ArrayList<Individual> children = new ArrayList<Individual>();

    int numParents = Evolution.getCurrentPopulation().size() - Parameters.getElitismNumber();
    ...
    for (int i = 0; i < numParents; i++) {
        parents.add(tournamentSelection1Parent());
    }
    ...
    while (parents.size() > 0) {
        ...
        if (generator.nextDouble() < Parameters.getCrossoverRate()) {
            ...
            if (numActiveTermsRule1 == 0 || numActiveTermsRule2 == 0) {
                ...
                Individual child1 = new Individual(rule1, posActiveTermsRule1);
                Individual child2 = new Individual(rule2, posActiveTermsRule2);
            ...
            Individual child1 = new Individual(parent1.getRule(), parent1.getPosActiveTerms());
            Individual child2 = new Individual(parent2.getRule(), parent2.getPosActiveTerms());
...
/* ===========================================================
     ...
     * =========================================================== */
public static ArrayList<Individual> uniformCrossoverRandom() {
    ArrayList<Individual> children = new ArrayList<Individual>();
    int numChildren = Evolution.getCurrentPopulation().size() - Parameters.getElitismNumber();

    while (children.size() < numChildren) {
        ArrayList<Individual> parents = new ArrayList<Individual>();
        parents = tournamentSelection2Parents();
...
/* ===========================================================
     ...
     * =========================================================== */
private static Individual tournamentSelection1Parent() {
    ...
    while (i < sizeTournament) {
        int index = generator.nextInt(Evolution.getCurrentPopulation().size());

        if (candidates.contains(Evolution.getCurrentPopulation().get(index)) == false) {
            candidates.add(Evolution.getCurrentPopulation().get(index));
            i++;
        }
    }
...
/* ===========================================================
     ...
     * =========================================================== */
private static ArrayList<Individual> tournamentSelection2Parents() {
    ArrayList<Individual> candidates = new ArrayList<Individual>();
    int sizeTournament = Parameters.getSizeTournament();
    ...
    while (i < sizeTournament) {
        ...
        if (candidates.contains(Evolution.getCurrentPopulation().get(index)) == false
                && parents.contains(Evolution.getCurrentPopulation().get(index)) == false) {
            candidates.add(Evolution.getCurrentPopulation().get(index));
            i++;
        }
    }
...
public static ArrayList<Individual> localSearchOperatorMaxFitness(ArrayList<Individual> individuals) {
    ...
    for (int i = 0; i < individuals.size(); i++) {
        ...
        while ((individual.getFitness() >= previousFitness
            ...
            individual = new Individual(individual.getRule(), individual.getPosActiveTerms());
            individuals.set(i, individual);
        }
        //Return the previous individual
        individual = new Individual(previousRule, previousPosActiveTerms);
        individuals.set(i, individual);
    }
...
public static ArrayList<Individual> mutation(ArrayList<Individual> children) {
    ...
    for (int i = 0; i < indexChildrenMutation.size(); i++) {
        ...
        if (generator.nextDouble() <= 0.5) {
            ...
            Individual individual = new Individual(rule, posActiveTerms);
            ...
            //Substitute the individual by the mutated
            Individual individual = new Individual(children.get(indexIndividual).getRule(), children.get(indexIndividual).getPosActiveTerms());
            children.set(indexIndividual, individual);
        }
    }
