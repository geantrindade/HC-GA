...
//        -------------------------------------------------------------------------------
        ...
        fitness = (0.4 * varianceGain) + (0.6 * percentageCoverage) / percentageCoverage;
